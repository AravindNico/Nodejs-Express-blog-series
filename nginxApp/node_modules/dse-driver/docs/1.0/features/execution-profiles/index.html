...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>DataStax Enterprise Node.js Driver - Execution Profiles</title>
            ...
            <div class="text-info">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="current-version">
                  ...
                  <li><a href="../../../features/execution-profiles/">1.1</a></li>
          ...
          <div class="crumbs-wrapper">
            <nav id="crumbs" data-spy="affix" data-offset-top="130">
              <ol class="breadcrumb">
                ...
                <li class="active">Execution Profiles</li>
...
<ul>
<li>Graph name</li>
<li>Graph traversal source</li>
<li>Graph read consistency</li>
<li>Graph write consistency</li>
</ul>
</li>
</ul>
...
<pre class="highlight"><code><span class="kr">const</span> <span class="nx">client</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Client</span><span class="p">({</span> 
  ...
  <span class="na">profiles</span><span class="p">:</span> <span class="p">[</span> 
    ...
    <span class="p">}),</span>
    <span class="k">new</span> <span class="nx">ExecutionProfile</span><span class="p">(</span><span class="s1">'graph-oltp'</span><span class="p">,</span> <span class="p">{</span>
      <span class="na">consistency</span><span class="p">:</span> <span class="nx">consistency</span><span class="p">.</span><span class="nx">localQuorum</span><span class="p">,</span>
...
read timeout for the profile named <code>'graph-oltp'</code> will be the one defined in the default profile (10,000 ms).</p>
...
<pre class="highlight"><code><span class="nx">client</span><span class="p">.</span><span class="nx">execute</span><span class="p">(</span><span class="nx">query</span><span class="p">,</span> <span class="nx">params</span><span class="p">,</span> <span class="kc">null</span><span class="p">,</span> <span class="nx">callback</span><span class="p">);</span>
</code></pre>
