...
<p>The driver supports versions from 4.8 to 5 of <a href="http://www.datastax.com/products/datastax-enterprise">DataStax Enterprise</a>.</p>
...
<h3 id="where-can-i-find-more-tutorials-or-documentation" class="target">Where can I find more tutorials or documentation?<a class="anchor" href="#where-can-i-find-more-tutorials-or-documentation" aria-hidden="true"><span class="glyphicon glyphicon-link"></span></a>
</h3>

<p>All the functionality present in the Cassandra driver is available on the DSE driver, <a href="http://datastax.github.io/nodejs-driver/features/">any tutorial or documentation
that references the DataStax Node.js driver for Apache Cassandra also applies to this driver</a>.</p>
